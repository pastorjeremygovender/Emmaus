...
export default function ContentStudioListItem({
  ...
  return (
    <div className="flex items-center gap-4 bg-white border border-gray-100 rounded-xl px-4 py-3.5 hover:border-gray-200 hover:bg-gray-50/40 transition-colors group">
